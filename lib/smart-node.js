        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    let response = yield axios_1.default.get(`${node.url}/launchpad/list`);
                    response.data.forEach((data) => {
                        data.image = `${node.url}/${data.image}`;
                        data.launchpad.forEach((round) => {
    ...
    getAccountInfos(network, accountId) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    let node = this.getNode(network);
                    let response = yield axios_1.default.get(`${node.url}/wallets/info?accountId=${accountId}`);
                    resolve({
    ...
    getAccountBalance(network, accountId) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    let node = this.getNode(network);
                    let response = yield axios_1.default.get(`${node.url}/wallets/balance?accountId=${accountId}`);
                    resolve({
                        function: 'getAccountInfos',
                        node: node,
                        data: response.data
